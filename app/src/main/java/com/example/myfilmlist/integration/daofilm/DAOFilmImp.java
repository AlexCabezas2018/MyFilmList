...
public class DAOFilmImp extends DAOFilm{
     ...
     */
    private static List<TFilmPreview> getPreviewFilmsFromJSON(JSONObject jsonObject) throws JSONException {
    ...
    private static TFilmFull getFullFilmFromJSON(JSONObject jsonObject) throws JSONException{
        ...
        filmToReturn.setActors(Arrays.asList(jsonObject.getString("Actors").split(" ")));
