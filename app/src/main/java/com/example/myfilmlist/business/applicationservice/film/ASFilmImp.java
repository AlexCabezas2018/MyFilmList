...
import com.example.myfilmlist.business.Utils;
...
public class ASFilmImp extends ASFilm {
    ...
    public List<TFilm> searchByName(String filmName) throws ASException {
        ...
        try{
            String resultFilmName = Utils.getCompoundName(filmName); //We obtain the compound name (If the tittle is composed of more than one word)
